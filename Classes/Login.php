...
#
# @Login[Class]  - handles the user's login and logout process
#
            ...
            if (!$this->db_connection->connect_errno) {
                ...
                if ($result_of_login_check->num_rows == 1) {
                    ...
                    if (password_verify($_POST['user_password'], $result_row->user_password_hash)) {
                        ...
                        $_SESSION['user_permission'] = $result_row->user_group;
                        $_SESSION['user_login_status'] = 1;
                        $_SESSION['user_fullname'] = $result_row->user_fname . ' ' . $result_row->user_lname;
